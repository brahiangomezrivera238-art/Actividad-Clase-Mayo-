...
Este proyecto es una aplicación web completa para la gestión de inventario de una tienda de tecnología. Cuenta con un **Backend** construido con Node.js y Express, y un **Frontend** dinámico construido con HTML, CSS y JavaScript utilizando la Fetch API nativa.

## Integrantes
* **Brahian David Gómez Rivera**
* **SAMUEL MOLINA**
...
![Interfaz del Proyecto](screenshot.png)
